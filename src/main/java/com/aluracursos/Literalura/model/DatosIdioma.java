...
public enum DatosIdioma {
    // Enumeración de idiomas con su correspondiente código abreviado
    ABJASO("ab"),
    AFAR("aa"),
    AFRIKAANS("af"),
    AIMARA("ay"),
    ...
    private String idioma; // Variable de instancia para almacenar el código del idioma

    // Constructor privado para inicializar el enum con el código del idioma
    ...
    public static DatosIdioma fromString(String text) {
        // Método para obtener el enum a partir de su código de idioma
